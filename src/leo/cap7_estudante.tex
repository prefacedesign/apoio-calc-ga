...
A questão abaixo foi retirada da seção 1.3 do livro \sugestao{Calculus}, de James Stewart. Pode parecer um retrocesso em termos de conteúdo voltar para o primeiro capítulo do livro, mas essa seção está ligada ao que será discutido no capítulo 4.
...
Agora, resolva a questão a seguir, retirada da mesma seção do livro \sugestao{Calculus}, de James Stewart.
