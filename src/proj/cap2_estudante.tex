...
Tá ok?
\begin{itemize}
 \item Produto de potências: $a^n \cdot a^m = a^{n+m}$ listadas abaixo, sugerimos que leia a seção 1.8 do livro \sugestao{Matemática Básica, volume 1} até a página 70 e então volte para esta questão.
