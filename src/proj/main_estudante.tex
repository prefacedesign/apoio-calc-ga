...
\newlength{\identacao}
\setlength{\identacao}{1\gridM-5pt}%
...
\pagestyle{fancy}
\fancyhf{}
%\fancyfoot[CE,CO]{\hbox to 2\gridM{\thepage\hfill}\hbox to 8\gridM{\leftmark\hfill}}
%\fancyfoot[LE,LO]{\hbox to 14\gridM{\hspace{-2\gridM}\leftmark} \hbox to 14\gridM{\hspace{-2\gridM}\rule[0pt]{14\gridM}{0.5pt}}
\fancyfoot[LO]{%
	\vspace{0.5\gridL}
	\hbox to 16\gridM{\hspace{-2\gridM}\hbox to 14\gridM{\rule[0.5\gridL]{14\gridM}{0.5pt}}}
...
\markboth{#1}{}}
%\renewcommand{\headwidth}{10\gridM}
